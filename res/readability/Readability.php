...
namespace Scrappers_project_AASTU_andreskrey\Readability;

use Scrappers_project_AASTU_andreskrey\Readability\Nodes\DOM\DOMDocument;
use Scrappers_project_AASTU_andreskrey\Readability\Nodes\DOM\DOMElement;
use Scrappers_project_AASTU_andreskrey\Readability\Nodes\DOM\DOMNode;
use Scrappers_project_AASTU_andreskrey\Readability\Nodes\DOM\DOMText;
use Scrappers_project_AASTU_andreskrey\Readability\Nodes\NodeUtility;
use Psr\Log\LoggerInterface;

/**
 * Class ReadabilityScrappers_project_AASTU.
 */
if(!class_exists('ReadabilityScrappers_project_AASTU'))
{
class ReadabilityScrappers_project_AASTU
{
    /**
