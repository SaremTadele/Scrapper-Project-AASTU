...
registerBlockType( 'Scrappers_project_AASTU-news-post-generator/Scrappers_project_AASTU-list', {
    title: 'Scrappers_project_AASTU List Posts',
    icon: 'testimonial',
    category: 'embed',
    attributes: {
        ruletype : {
    ...
    keywords: ['list', 'posts', 'Scrappers_project_AASTU'],
    edit: (function( props ) {
		...
		return gcel(
            ...
            gcel(
                ...
                'Scrappers_project_AASTU List Posts ',
                gcel(
                    'div', 
			...
			gcel(
				'textarea',
				{ rows:1,placeholder:'Category slug', value: category, onChange: updateMessage3, className: 'AAStu_students_gutenberg_input' }
			),
            gcel(
				'br'
			),
			...
			gcel(
				'input',
				{ type:'number',min:1,placeholder:'10', value: posts, onChange: updateMessage4, className: 'AAStu_students_gutenberg_input' }
			),
            gcel(
				'br'
			),
            ...
            gcel(
				'select',
				{ value: orderby, onChange: updateMessage5, className: 'AAStu_students_gutenberg_select' }, 
                gcel(
                    'option',
                    { value: 'none'},
                    'none'
            ...
            gcel(
				'select',
				{ value: order, onChange: updateMessage6, className: 'AAStu_students_gutenberg_select' }, 
                gcel(
                    'option',
                    { value: 'ASC'},
                    'ASC'
			...
			gcel(
				'textarea',
				{ rows:1,placeholder:'post', value: type, onChange: updateMessage7, className: 'AAStu_students_gutenberg_input' }
			)
		);
    }),
    save: (function( props ) {
