...
registerBlockType( 'Scrappers_project_AASTU-news-post-generator/Scrappers_project_AASTU-display', {
    title: 'Scrappers_project_AASTU Display Posts',
    icon: 'testimonial',
    category: 'embed',
    attributes: {
        ruletype : {
    ...
    keywords: ['display', 'posts', 'Scrappers_project_AASTU'],
    edit: (function( props ) {
		...
		return gcel(
			'div', 
			{ className: 'AAStu_students_gutenberg_div' },
            gcel(
				'h4',
				{ className: 'AAStu_students_gutenberg_title' },
                'Scrappers_project_AASTU Display Posts ',
                gcel(
                    'div', 
            ...
            gcel(
				'label',
				{ className: 'AAStu_students_gutenberg_label' },
                'Rule Type: '
			),
            gcel(
                'div', 
			...
			gcel(
				'select',
				{ value: ruletype, onChange: updateMessage, className: 'AAStu_students_gutenberg_select' }, 
                gcel(
                    'option',
                    { value: 0},
			...
			gcel(
				'input',
				{ type:'number',min:0,placeholder:'Rule id to list', value: ruleid, onChange: updateMessage2, className: 'AAStu_students_gutenberg_input' }
			),
            gcel(
				'br'
			),
            ...
            gcel(
				'select',
				{ value: wrapper, onChange: updateMessage3, className: 'AAStu_students_gutenberg_select' }, 
                gcel(
                    'option',
                    { value: 'ul'},
                    'List'
			...
			gcel(
				'textarea',
				{ rows:1,placeholder:'Read more...', value: read_more_text, onChange: updateMessage4, className: 'AAStu_students_gutenberg_input' }
			),
            gcel(
				'br'
			),
			...
			gcel(
				'textarea',
				{ rows:1,placeholder:'div class', value: wrapper_class, onChange: updateMessage5, className: 'AAStu_students_gutenberg_input' }
			),
            gcel(
				'br'
			),
			...
			gcel(
				'textarea',
				{ rows:1,placeholder:'10px', value: excerpt_font_size, onChange: updateMessage6, className: 'AAStu_students_gutenberg_input' }
			),
            gcel(
				'br'
			),
			...
			gcel(
				'textarea',
				{ rows:1,placeholder:'12px', value: title_font_size, onChange: updateMessage7, className: 'AAStu_students_gutenberg_input' }
			),
            gcel(
				'br'
			),
			...
			gcel(
				'textarea',
				{ rows:1,placeholder:'#000000', value: excerpt_color, onChange: updateMessage8, className: 'AAStu_students_gutenberg_input' }
			),
            gcel(
				'br'
			),
			...
			gcel(
				'textarea',
				{ rows:1,placeholder:'#000000', value: title_color, onChange: updateMessage9, className: 'AAStu_students_gutenberg_input' }
			),
            gcel(
				'br'
			),
			...
			gcel(
				'input',
				{ type:'number',min:1,placeholder:'10', value: posts_per_page, onChange: updateMessage10, className: 'AAStu_students_gutenberg_input' }
			),
            gcel(
				'br'
			),
			...
			gcel(
				'textarea',
				{ rows:1,placeholder:'post', value: post_type, onChange: updateMessage11, className: 'AAStu_students_gutenberg_input' }
			),
            gcel(
				'br'
			),
            ...
            gcel(
				'select',
				{ value: orderby, onChange: updateMessage12, className: 'AAStu_students_gutenberg_select' }, 
                gcel(
                    'option',
                    { value: 'none'},
                    'none'
			...
			gcel(
				'textarea',
				{ rows:1,placeholder:'No posts found.', value: no_posts_message, onChange: updateMessage13, className: 'AAStu_students_gutenberg_input' }
			),
            gcel(
				'br'
			),
            ...
            gcel(
				'select',
				{ value: include_title, onChange: updateMessage14, className: 'AAStu_students_gutenberg_select' }, 
                gcel(
                    'option',
                    { value: 'true'},
                    'true'
            ...
            gcel(
				'select',
				{ value: include_link, onChange: updateMessage15, className: 'AAStu_students_gutenberg_select' }, 
                gcel(
                    'option',
                    { value: 'true'},
                    'true'
            ...
            gcel(
				'select',
				{ value: include_excerpt, onChange: updateMessage16, className: 'AAStu_students_gutenberg_select' }, 
                gcel(
                    'option',
                    { value: 'false'},
                    'false'
            ...
            gcel(
				'select',
				{ value: include_date, onChange: updateMessage17, className: 'AAStu_students_gutenberg_select' }, 
                gcel(
                    'option',
                    { value: 'false'},
                    'false'
            ...
            gcel(
				'select',
				{ value: include_content, onChange: updateMessage18, className: 'AAStu_students_gutenberg_select' }, 
                gcel(
                    'option',
                    { value: 'false'},
                    'false'
            ...
            gcel(
				'select',
				{ value: include_author, onChange: updateMessage19, className: 'AAStu_students_gutenberg_select' }, 
                gcel(
                    'option',
                    { value: 'false'},
                    'false'
            ...
            gcel(
				'select',
				{ value: image_size, onChange: updateMessage20, className: 'AAStu_students_gutenberg_select' }, 
                gcel(
                    'option',
                    { value: 'thumbnail'},
                    'thumbnail'
            ...
            gcel(
				'select',
				{ value: excerpt_more, onChange: updateMessage21, className: 'AAStu_students_gutenberg_select' }, 
                gcel(
                    'option',
                    { value: 'false'},
                    'false'
            ...
            gcel(
				'select',
				{ value: excerpt_more_link, onChange: updateMessage22, className: 'AAStu_students_gutenberg_select' }, 
                gcel(
                    'option',
                    { value: 'false'},
                    'false'
			...
			gcel(
				'input',
				{ type:'number', min:1, placeholder:'30', value: excerpt_length, onChange: updateMessage23, className: 'AAStu_students_gutenberg_input' }
			),
            gcel(
				'br'
			),
			...
			gcel(
				'textarea',
				{ rows:1,placeholder:'(n/j/Y)', value: date_format, onChange: updateMessage24, className: 'AAStu_students_gutenberg_input' }
			),
            gcel(
				'br'
			),
			...
			gcel(
				'textarea',
				{ rows:1,placeholder:'content', value: content_class, onChange: updateMessage25, className: 'AAStu_students_gutenberg_input' }
			),
            gcel(
				'br'
			),
			...
			gcel(
				'textarea',
				{ rows:1,placeholder:'author name', value: author, onChange: updateMessage26, className: 'AAStu_students_gutenberg_input' }
			)
		);
    }),
    save: (function( props ) {
